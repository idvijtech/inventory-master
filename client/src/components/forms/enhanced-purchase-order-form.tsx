...
const enhancedPurchaseOrderSchema = z.object({
  ...
  status: z.enum(["draft", "pending", "approved", "fulfilled", "cancelled"]),
...
type EnhancedPurchaseOrderFormData = z.infer<typeof enhancedPurchaseOrderSchema>;
...
export function EnhancedPurchaseOrderForm({
  ...
  const form = useForm<EnhancedPurchaseOrderFormData>({
    resolver: zodResolver(enhancedPurchaseOrderSchema),
    defaultValues: {
      orderNumber: generateOrderNumber("PO"),
      orderDate: new Date().toISOString().split('T')[0],
      paymentTerms: "net_30",
      status: "draft",
      items: [{ productId: 0, quantity: 1, purchasePrice: 0, taxPercent: 0, discountPercent: 0 }],
    },
  });
  ...
  const handleSubmit = (data: EnhancedPurchaseOrderFormData) => {
    const enhancedData = {
      ...data,
      ...totals,
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            <CardTitle className="text-white">Purchase Order Details</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-300">Reference Number</FormLabel>
                    <FormControl>
                      <Input 
                        {...field} 
                        className="bg-gray-700 border-gray-600 text-white"
                        placeholder="Vendor reference/quotation no."
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-300">Expected Delivery Date</FormLabel>
                    <FormControl>
                      <Input 
                        {...field} 
                        type="date"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-300">Delivery Location</FormLabel>
                    <FormControl>
                      <Input 
                        {...field} 
                        className="bg-gray-700 border-gray-600 text-white"
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-white">Product Line Items</CardTitle>
            <Button
              type="button"
              onClick={() => append({ productId: 0, quantity: 1, purchasePrice: 0, taxPercent: 0, discountPercent: 0 })}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="flex justify-between text-gray-300">
                  ...
                  <span>{formatCurrency(totals.totalBeforeTax)}</span>
                </div>
                <div className="flex justify-between text-gray-300">
